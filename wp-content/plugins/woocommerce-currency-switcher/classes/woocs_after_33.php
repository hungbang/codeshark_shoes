...
//*** checking and assigning data
    ...
    public function admin_head() {
        ...
        if (function_exists("wc_get_order_types") AND in_array($typenow, wc_get_order_types('order-meta-boxes'), true)) {
            wp_enqueue_script('woocs-orders-script', WOOCS_LINK . 'js/orders.js', array('jquery'));
        }
        wp_enqueue_style('woocs-admin-style', WOOCS_LINK . 'css/admin.css');
    }
...
//for orders hook
    ...
    public function woocs_order_metabox($post) {
        ...
        wp_enqueue_script('woocs-meta-script', WOOCS_LINK . 'js/meta-box.js', array('jquery'));
...
//as it recounted twice - down it!
    ...
    function woocs_alert() {
        if (isset($_GET['tab']) AND $_GET['tab'] == 'woocs') {
            ...
            <?php
            wp_enqueue_script('woocs-alert', WOOCS_LINK . 'js/alert.js', array('jquery'));
        }
    }
